...
-(void) onResp:(BaseResp*)resp
{
    if([resp isKindOfClass:[SendMessageToWXResp class]])
    {
        ...
        UIAlertView *alert = [[UIAlertView alloc] initWithTitle:@"温馨提示" message:@"发送成功" delegate:self cancelButtonTitle:@"OK" otherButtonTitles:nil, nil];
        [alert show];
...
- (void) sendLinkContent
{
    ...
    [message setThumbImage:[UIImage imageNamed:@"mid.png"]];
